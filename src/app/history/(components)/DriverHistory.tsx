...
export default function DriverHistory({ setTab }: IProps) {
  ...
  return (
    <div>
      <div className='w-[367px] h-[46px] bg-[#EEEEEE] rounded-xl flex justify-between items-center gap-1 text-secondary font-bold'>
        <Button
          className='w-4/5 flex items-center justify-center bg-[#EEEEEE] h-4/5 ml-1.5 rounded-xl text-secondary font-jura'
          onClick={handleClick}
        >
          <p>Passenger</p>
        </Button>
        <Button className='w-4/5 flex items-center justify-center bg-white h-4/5 mr-1.5 rounded-xl text-secondary font-jura '>
          <p>Driver</p>
        </Button>
      </div>
